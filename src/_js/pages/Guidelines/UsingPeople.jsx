...
const UsingPeople = ({ match }) => (
  <section>
    ...
    <h2>Using People<NavLink to={`${match.params.id}#people`} title="Using People">#</NavLink></h2>
    <div>
      <p>While people can be very expressive in communicating things, we use them sparingly. We are moving away from the existing Microsoft geeky developer people to a somewhat more natural approach to features, hands etc, yet with a similar level of simplicity.</p>
      <Image
